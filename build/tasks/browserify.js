...
var bannerTemplate = '/*! p5.maps.js v<%= pkg.version %> <%= grunt.template.today("mmmm dd, yyyy") %> */';
...
module.exports = function(grunt) {
  ...
  var libFilePath = path.resolve('lib/p5.maps.js');

  grunt.registerTask('browserify', 'Compile the p5.maps.js source with Browserify', function() {
    ...
    bundle.on('data', function(data) {
      ...
      grunt.log.writeln('>>'.green + ' Bundle ' + 'lib/p5.maps.js'.cyan + ' created.');
